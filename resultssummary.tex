...
Let $M = \PP^1 \times \PP^1 \times \PP^1 \bs dP_6$ and let $D=dP_6$. There is the so-called ``homology Gysin sequence'' (from \cite{dimca_singularities}), which will help us compute much of the homology of $M$:
