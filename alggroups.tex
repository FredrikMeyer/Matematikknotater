...
\abstract{
These are notes from the course Algebraic Geometry III. We work over a field of characteristic zero.
}
...
\end{prop}
\begin{proof}
sketch send $D$ to $\restr{D}{\mm_p}$. 
\end{proof}
[[ Also $\Hom_k(k[\epsilon],\OO_{X,p})$.
