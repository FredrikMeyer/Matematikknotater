...
\subsection{The boundary $\partial c$ of a chain}
...
We have a pairing:
\[
\int: H_k(M,\R) \times H_{dR}^k(M) \to \R.
\]
\end{prop}
\begin{proof}
...
\section{Connections with  algebraic geometry}

Every smooth algebraic variety (over $\R$ or $\CC$) is also a smooth manifold.
