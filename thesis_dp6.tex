...
The computations for $X_2$ are similar but more involved. We first note that the Picard group of $M=\PP(\mathcal T_{\PP^2})$ is generated by the pullbacks $F,G$ of the generators of $\Pic(\PP^2_{x_0x_1x_2} \times \PP^2_{y_0y_1y_2})$. Say $F$ is represented by $V(x_0)$ and $G$ is represented by $V(y_0)$\todo{check transversal intersection with dP6}.
